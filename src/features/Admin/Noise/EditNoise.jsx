...
const Editnoise = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if ((value1.noise.type !== undefined || !value1.noise.includes('fakepath')) && (value1.featuredImage.type !== undefined || !value1.featuredImage.includes('fakepath'))) {
            setIsLoad(true);
            let str = "";
        ...
        <>
            <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: "12px" }}>
                    ...
                    <ReactAudioPlayer
                        src={`https://immunify-backend.herokuapp.com/${value1.noise}`}
                        controls
                    />
                </div>
